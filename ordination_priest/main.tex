...
\chap{De Ordinatione Presbyteri}{
	...
	Salvatorem} has been sung, the Bishop, once the gremiale has been removed,
	goes from the faldstool to the altar and sits on the faldstool, where he
	gives away the crozier and receives the gremiale.
	...
	saying Accédat qui ordinándus est ad órdinem presbyterátus. He then calls
	the ordinand by name.
